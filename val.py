...
def run(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        for si, pred in enumerate(out):
            ...
            if nl:
                ...
                correct = process_batch(predn, labelsn, iouv, iou_mode)
                if plots:
    ...
    if len(stats) and stats[0].any():
        p, r, ap, f1, ap_class = ap_per_class(*stats, iou_thres=test_iou_thres, plot=plots, save_dir=save_dir, names=names)
