...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5x_arcade.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/data/Arcade_dataset/arcade/arcade.yaml', help='dataset.yaml path')
